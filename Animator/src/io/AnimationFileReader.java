...
public class AnimationFileReader {
  ...
  /**
   * Reads the canvas info from the input file and returns a CanvasInfo object.
   * @param sc the given scanner used to read the input file
   * @return a CanvasInfo object
   */
  ...
  /**
   * Reads a given Rectangle's info from an input file and returns it as an object.
   * @param sc the given scanner used to read the input file
   * @return a RectangleInfo object
   * @throws IllegalStateException if the input is not valid
   * @throws InputMismatchException if the type of the variable is not the type required
   */
  ...
  /**
   * Reads a given Oval's info from an input file and returns it as an object.
   * @param sc the given scanner used to read the input file
   * @return a OvalInfo object
   * @throws IllegalStateException if the input is not valid
   * @throws InputMismatchException if the type of the variable is not the type required
   */
  ...
  /**
   * Reads a given Move of a Shape from an input file and returns it as an object.
   * @param sc the given scanner used to read the input file
  ...
  /**
   * Reads a given ChangeColor of a Shape from an input file and returns it as an object.
   * @param sc the given scanner used to read the input file
   * @return a ChangeColorInfo object
   * @throws IllegalStateException if the input is not valid
   * @throws InputMismatchException if the type of the variable is not the type required
   */
  ...
  /**
   * Reads a given ScaleBy of a Shape from an input file and returns it as an object.
   * @param sc the given scanner used to read the input file
   * @return a ScaleBy object
   * @throws IllegalStateException if the input is not valid
   * @throws InputMismatchException if the type of the variable is not the type required
   */
  ...
  class CanvasInfo {
    ...
    /**
     * Sets width of canvas to given input.
     * @param w an int
     */
    void setWidth(int w) {
      width = w;
    ...
    /**
     * Sets height of canvas to given input.
     * @param h an int
     */
  ...
  /**
   * Represents an inputable.
   */
  class Inputable {
    protected Map<String, Boolean> valueFlags;

    /**
     * Constructor for an Inputable.
     */
    public Inputable() {
    ...
    /**
     * Checks if all entries are initialized.
     * @return boolean for above condition.
     */
  ...
  class ShapeInfo extends Inputable {
    ...
    /**
     * Creates a ShapeInfo object that extends Inputable.
     */
    ShapeInfo() {
      super();
  ...
  class RectangleInfo extends ShapeInfo {
    ...
    /**
     * Creates a RectangleInfo object that extends ShapeInfo.
     */
    RectangleInfo() {
      super();
  ...
  class OvalInfo extends ShapeInfo {
    ...
    /**
     * Creates a OvalInfo object that extends ShapeInfo.
     */
    OvalInfo() {
      super();
  ...
  class MoveInfo extends Inputable {
    ...
    /**
     * Creates a MoveInfo object that extends Inputable.
     */
    MoveInfo() {
      super();
  ...
  class ChangeColorInfo extends Inputable {
    ...
    /**
     * Creates a ChangeColorInfo object that extends Inputable.
     */
    ChangeColorInfo() {
      super();
  ...
  class ScaleByInfo extends Inputable {
    ...
    /**
     * Creates a ScaleByInfo object that extends Inputable.
     */
    ScaleByInfo() {
      super();
